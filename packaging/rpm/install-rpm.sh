...
echo ""
echo "  sudo dnf install claude-desktop-extra"
echo ""
echo "Future updates via: sudo dnf upgrade claude-desktop-extra"
echo ""
echo "(Existing claude-desktop-bin installs are migrated automatically on upgrade.)"
