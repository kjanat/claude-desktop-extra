...
#
# Usage: curl -fsSL https://kjanat.github.io/claude-desktop-extra/install.sh | sudo bash
...
case "$(dpkg --print-architecture)" in
	...
	*)
		echo "Error: Unsupported architecture: $(dpkg --print-architecture) (supported: amd64, arm64)"
		exit 1
		;;
esac
...
echo ""
echo "  sudo apt install claude-desktop-extra"
echo ""
