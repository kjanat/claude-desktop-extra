...
```bash
wget https://github.com/kjanat/claude-desktop-extra/releases/latest/download/claude-desktop-extra_1.26832.0-2_amd64.deb
...
```bash
wget https://github.com/kjanat/claude-desktop-extra/releases/latest/download/claude-desktop-extra-1.26832.0-2.x86_64.rpm
