...
curl -fsSL https://github.com/kjanat/claude-desktop-extra/raw/master/packaging/pacman/install-pacman.sh | sudo bash
...
```bash
wget https://github.com/kjanat/claude-desktop-extra/releases/latest/download/claude-desktop-extra_1.24012.11-2_amd64.deb
...
```bash
wget https://github.com/kjanat/claude-desktop-extra/releases/latest/download/claude-desktop-extra-1.24012.11-2.x86_64.rpm
...
wget https://github.com/kjanat/claude-desktop-extra/releases/latest/download/Claude_Desktop-1.24012.11-x86_64.AppImage
...
<!-- markdownlint-disable-file MD010 MD013 MD033 MD051 -->
