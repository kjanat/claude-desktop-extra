;/*__CDB_GB_OVERRIDES__*/(function () {
  ...
  var TEMPLATE = [
    ...
    "// Desktop v1.26832.0 is listed below, commented out. Uncomment a line to force",
    ...
    "// release (this list reflects v1.26832.0). If the app misbehaves, empty this",
    "// file first.",
    "{",
    "  // \"activeTheme\": \"mario\",",
    "",
    ...
    "    // \"959099749\": true, // startup feature-probe batch member (near louderPenguin/coworkKappa) (new in v1.26832.0)",
    ...
    "    // \"1953041099\": true,   // skill description/prompt text override (value flag - server strings)",
    ...
    "    // \"2678393595\": true, // git-status implementation switch (new in v1.26832.0)",
